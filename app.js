...
const sweepstakeData = {
  ...
  teamResults: {
    ...
    "Czech Republic": {},
    "New Zealand": {},
    Morocco: { second: true, ro32: true },
    Uruguay: {},
    Algeria: { groupThird: true },
    Scotland: {},
    Ghana: { groupThird: true },
    France: { first: true, ro32: true },
    Colombia: { first: true },
